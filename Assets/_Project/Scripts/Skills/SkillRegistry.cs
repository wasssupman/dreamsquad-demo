...
namespace Wassup.Skills
{
    ...
    public sealed class SkillRegistry
    {
        ...
        // 아니다」** 다 — 숙제가 아니라 분류다. **정본 목록은 `SkillPayloadPolicy` 이고
        // 일곱을 센다**(리뷰 M-2 — 여기가 「둘」이라 적어 두 정본이 갈려 있었다).
        // 그중 이유가 서로 다른 둘만 여기 적는다 — 나머지 다섯(분열·손패 회수·발사 명세로
        // 이관된 융단폭격·죽은 값·센티넬)은 그 파일에 이유가 있다:
        //
