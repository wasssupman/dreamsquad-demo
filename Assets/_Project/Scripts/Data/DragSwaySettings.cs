...
namespace Wassup.Data
{
    ...
    public class DragSwaySettings : ScriptableObject
    {
        ...
        [Tooltip("지형 배치 불가 — 보드 전역 표시. 유닛을 들면 켜진다.\n" +
                 ...
                 "⚠ **밝은** 차가운 회색이다. 어두운 쪽(0.12,0.12,0.15)을 먼저 시도했다가 되돌렸다 — " +
                 "아스팔트는 크랙·그림자로 명도가 이미 요동치는 표면이라 **어둡게 덮는 신호는 그 노이즈에 묻힌다** " +
                 "(가장 큰 불가 영역인 웅덩이 위에서는 완전히 사라졌다). 옛 빨강이 통했던 건 명도가 아니라 " +
                 "**색상**으로 말했기 때문이고, 무채색으로 같은 분리를 얻으려면 **밝은 쪽**이어야 한다.\n" +
                 "「조용함」은 밝기가 아니라 **채도**에서 온다 — 채도 0 이면 아무리 밝아도 «정보»가 아니라 «재질»로 읽힌다.")]
        public Color ghostTerrainColor = new Color(0.80f, 0.84f, 0.90f, 0.40f);
