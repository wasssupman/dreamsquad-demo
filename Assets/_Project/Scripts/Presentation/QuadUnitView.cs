...
namespace Wassup.Presentation
{
    ...
    public class QuadUnitView : MonoBehaviour
    {
            ...
            float bodyRadiusTiles)
        {
            ...
            // tilemap-real-shadows rev 2026-09-04 — 블롭 **상시** + 캐스트는 더하기(Spine 경로와
            // 같은 결정 · 상호배타 폐기). URP/Unlit + _ALPHATEST_ON → ShadowCaster 가 실루엣 cast,
            // 평면이라 TwoSided.
            ...
            if (BattleBridge.BlobShadowSprite != null)
                ...
                _blob = BlobShadow.Attach(transform, BattleBridge.BlobShadowSprite,
                    2f * bodyRadiusTiles * BattleBridge.TileToWorld,
