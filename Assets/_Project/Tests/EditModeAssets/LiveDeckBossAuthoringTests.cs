...
namespace Wassup.Tests.EditMode
{
    ...
    public class LiveDeckBossAuthoringTests
    {
        ...
        //
        // 두 갈래가 만나며 살아났던 자리다: 엔드리스 제거는 이 테스트를 **옛 위치**
        // (`WaveConceptBossTests`)에서 지웠고, test-suite-fast-lane 은 같은 테스트를 이 파일로
        // **옮겼다**. 머지가 둘 다 반영해 삭제된 `Deck_Endless` 를 로드하는 테스트가 남았다.
