...
namespace Wassup.Tests.PlayMode
{
    ...
    public class OnPlaceApplyStackNearbyTest
    {
        ...
        public IEnumerator ApplyStackNearby_StacksEnemiesInRange_AndSkipsThoseOutside()
        {
            ...
            slasher.onPlaceMagnitude = 1f;
            slasher.onPlaceDuration = 4f;
            ...
            // ⚠ stackCount 로 단언하지 않는다: Bleed 규칙은 `atStack 1 · mode Consume` 이라
            // 1스택에 도달하는 순간 발화하며 **스택을 도로 소모**해 0으로 돌아간다. 스택 수는
