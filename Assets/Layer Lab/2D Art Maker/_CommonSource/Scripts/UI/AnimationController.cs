...
namespace LayerLab.ArtMaker
{
   public class AnimationController : MonoBehaviour
   {
       ...
       /// <summary>
       /// 버튼 리스너 정리 - 메모리 누수 방지
       /// Clean up button listeners - prevent memory leaks
       /// </summary>
       private void OnDestroy()
       {
           if (prevButton != null) prevButton.onClick.RemoveListener(PlayPreviousAnimation);
           if (nextButton != null) nextButton.onClick.RemoveListener(PlayNextAnimation);
       }
