...
|---|---|---|
| Burnout | 번아웃 | 아군 10초마다 피로 +1 · 5스택에 공격력·공속·최대체력 -20% (15초) |
| RedBull | 레드불 | 3초마다 레드불 스폰 · 밟으면 공속 +50% (5초), 종료 시 최대체력 50% 피해 |
| ClockOut | 사직서 | 아군 사망 시 사직서 드랍 · 5장마다 적에게 메테오 10발 |
| Onsen | 과열 | 5초마다 열기 +1 · 5스택까지 최대체력 10% 회복, 이후 10% 피해 (사망 없음) |
