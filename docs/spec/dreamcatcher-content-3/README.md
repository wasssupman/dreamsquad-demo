...
상태: 구현 완료 2026-07-25 (units 0~4 커밋 60e1f8d9 · bc27201e · 79d9f844 · 9a465578 · 9186ab85) — 사용자 Play 확인 대기
...
- HealthThreshold 반복 발동 문안 개선 — 진동갑주의 "HP 90% 이하" 표기가 "10% 잃을 때마다 반복" 의미를 약하게 전달 (트리거 문안이 payload 를 모르는 구조라 v1 보류)
