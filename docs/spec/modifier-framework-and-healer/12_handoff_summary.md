...
스킵된 2 테스트는 testability 결함 (private static dictionary, 인라인 dispatch) 때문이며 follow-up 후보에 포함.

## Follow-up

본 spec 의 후속 후보는 `docs/spec/README.md` 하단 **Follow-up Backlog** 의 "From `modifier-framework-and-healer`" 섹션에 모았다. 개별 항목별 What/Why/Scope 는 그쪽 참조.
