...
- **방향 미정**(드래그 중 + 조준 대기): **4레인 십자를 흐리게**(alpha ×0.7 — 초기값 0.45 는 시안 placeable 하이라이트가 비쳐 다른 색으로 오독돼 상향, 2026-07-19) + 유닛을 둘러싼 **화살표 4개** = "이 중 하나를 고른다".
...
- [x] Play 검증(사용자 2026-07-18, "확인됨"): 드롭 시 십자+화살표 → 방향 탭에 그 레인만 또렷 → 떼면 확정·소거. 화살표 z-acne 자글거림도 리프트 픽스(`1bb12070`)로 해소 확인
