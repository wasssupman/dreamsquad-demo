...
- [~] Play e2e 전체 플로우: 배선·조준 UX·화살표 렌더는 사용자 Play 확인됨(2026-07-18). **미확정 = "10연발이 적을 맞혀 데미지 넘버·사망까지" 전 구간 1패스** — 남은 사용자 확인. (시뮬 계약은 통합 테스트가 덮음)
- [ ] 실기기(Android) 스모크 1회 — 배치 2페이즈(드롭→방향 탭) 조작감 확인 (사용자)
