...
- [x] `DcMechanic.cs` 컴파일 (ECS/Battle 타입 무참조 유지).
- [x] 기존 드림캐쳐 카드 에셋 재직렬화 시 값 보존(새 필드 기본 0/None).
- [x] 이 문서 어휘가 §2·§3 로직 정의를 표현하기에 충분한지 렌즈 A 크리틱 확인.

확인 2026-07-10 — 컴파일 클린 + code-review(low) findings 0. 커밋 `63507a10`.
