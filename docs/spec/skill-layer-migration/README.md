...
- ⚠ **`ExecutedCount` 는 「하나라도 불렸다」만 증언한다.** 라우팅 그물이 실주행하는 것은
  마메모(주기 seam)뿐이라, **경계 seam**(장막·자폭·궁극기)의 라우팅은 여전히 「legacy 가
  돌아도 초록」이다 — `7f902e55` 가 잡은 바로 그 실패 유형이 절반 남아 있다.
  seam 별 카운터 또는 경계 보스 케이스를 추가해야 완전히 닫힌다.
