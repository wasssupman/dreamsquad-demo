...
- `Combat/NearestTargeting.cs` · `Combat/FrontmostTargeting.cs` · `Combat/LowestHealthTargeting.cs` · `Combat/AggroTargeting.cs` — tiebreak 축을 `entityIndex/Version` → `SimEntityId` 교체 (4번째 `AggroTargeting` 은 2026-08-03 교차검증에서 발견된 초안 누락)
