...
- [x] (in-memory 검증) 보스에 whip 슬롯 수동 베이크 → 3타일 내 적 `ModifierStats.moveSpeedMul == 1.2`, 범위 밖 1.0, 보스 자신 1.0 — MCP execute_code 로 확인. (2026-07-12 스크립트 배틀 프레임 모니터로 수행 — unit 2 확인 기록 참조)
