...
- **밀당맨이 적을 전진시킬 수 있다.** 제자리 공격 중이던 적이 사거리 밖으로 밀리면
...
- [ ] Play 육안 — 교전 중 적이 밀리는지 · 도발된 적 진동 · **코너 근처 톱니**(이 파일의 과거
      회귀 유형이라 정적 검증으로는 답이 안 난다) — 사용자 확인 대기
