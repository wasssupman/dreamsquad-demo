...
- **Defenders**: `id, displayName, role, rarity, health, attackRange, attackCooldown, hitDelaySec, deployDelaySec, attackTargetCount, cost, placementCooldown, deathCooldown, retireCooldownRatio, aggroCapacity, aggroRange, atk, heal`
