...
> 확인: 2026-07-08 사용자 Play 확인 통과 (작업 3·레이아웃 수정과 묶어 검증). 메뉴→팝업 정지(Battle scale 0)·[재개] 재개·[나가기] 아웃게임. 한글 버튼(Jua 동적 글리프). 레이아웃: 팝업 중복 dim 제거→스트립 오버레이 단일 dim, 스트립 order 950 부스트·버튼 하단 배치.
