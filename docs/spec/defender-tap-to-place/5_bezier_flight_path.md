...
> **후속 변경**: unit 6에서 3차 `CubicBezier` 던지기 경로로 교체됐다. 본 문서는 unit 5 당시의 2차 곡선 계약 기록이다.
...
> **확인 2026-07-18** (커밋 `95b08252`): 컴파일 클린 · EditMode 927(925 pass/0 fail, 베지어 테스트 포함) · 코드리뷰 clean · **사용자 Play 통과 확인**(매 탭 다른 곡선 아치, 목표 안착). 비행시간 1.5s 튜닝 = 커밋 `ceb7bfd5`.
