...
상태: **완료 2026-07-18 (units 0~8 사용자 Play 확인)** · 작성 2026-07-17
...
| 8 | `8_throw_flight_refactor.md` | refactor | 죽은 상태 제거 + 좌표/설정 흐름 명료화 |
| 9 | `9_refactor_handoff_summary.md` | doc | Unit 8 리팩토링·검증 인계 |
