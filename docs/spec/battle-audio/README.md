...
- **배치 추임새 — 일본 애니 성우 방향으로 전면 재생성** — 현재 커밋된 baseline(16 전부 한국어)은 사용자 청취 결과 "어색"으로 판정. 방향 전환 결정: **일본어 + 일본 애니 성우 보이스**. Archer 1종으로 방향 검증 완료(보이스 `Ayame`, lang=ja 네이티브, `eleven_v3` + expressive `{stability:0.4, similarity_boost:0.85, style:0.65, use_speaker_boost:true}`, 라인 「この一矢、はずさない！」). 남은 15종은 아래 초안 라인으로 각 캐릭터에 어울리는 ja 애니 보이스(남녀 랜덤) 배정해 일괄 재생성 필요. 파일 경로 덮어쓰기(GUID 유지 → SO 배선 불변). [M]
  - 초안 라인(ja): Archer「この一矢、はずさない！」 / Artillery「砲撃、準備完了！撃つよ！」 / Bastion「ここは通さない！」 / BlockingCaster「道を塞いじゃうよ！」 / Bruiser「正面から来い！」 / Cannon「一撃で吹き飛ばす！」 / FireCaster「全部燃やしつくす！」 / Guardian「みんな下がって！僕が守る！」 / Healer「みんな頑張って！回復するよ！」 / IceCaster「凍らせてあげる。」 / Marksman「狙い、定めた。命中。」 / Piercer「貫いてやる！」 / PoisonCaster「ふふっ、毒の味はどう？」 / Ranger「よし、行こう！」 / Scout「偵察完了！任せて！」 / Sniper「隠れても無駄だよ。」
- **배치 추임새 여러 라인 순환** — 현재 캐릭터당 1라인. 2~3라인 순환. [S]
