...
- 전체 터치 영역은 244×244 reference px, 표시 버튼은 220×220px이다. 투명 장식 외곽이
  아니라 원형 본체 전체가 Button hit target이다.
- 0에서도 버튼은 열려 손패를 확인할 수 있다. 충전량은 interactable 여부가 아니라 중앙
  액체면 높이와 본체 밝기로 표현한다.
...
확인: 2026-07-18 · 사용자 마감 확인 · 구현 `9acd4e37`, 최종 개정 `20eec6af`
