...
| 8 | 게이지 자리 = **보드 위**. rev(2026-08-23) — 머리 위 «바» 는 다른 바들과 문법이 같아 임팩트가 없다 → **마음 주변 3×3 잠식** |
...
| 1 | 프레젠테이션 | [`1_heart_stress_board.md`](1_heart_stress_board.md) | **rev** — 머리 위 바 은퇴 → **보드 잠식**(3×3 번짐 + 맥동) |
