...
- [x] Play: 마음이 맞을수록 **붉어지고** 잡으면 **돌아온다**
- [x] Play: 스트레스가 높을수록 **빠르게 뛴다**. 마음과 화면이 **같은 박자**다
- [x] Play: 낮은 스트레스에서 화면이 **거의 안 붉다**(후반 가중이 듣는가)
- [x] Play: 임시 프랍에서도 붉음이 읽힌다

**확인 2026-08-24** — 커밋 `30700433`(rev 2). 사용자 Play 확인 통과.
심박·단계·히스테리시스는 `HeartStressPulseTests` 가 고정한다(단조 증가 · lub-dub 비대칭 ·
누적 위상 · 후반 가중). 배율의 계산 주체는 브리지 한 곳이라 프랍과 화면이 같은 박자를 쓴다.
