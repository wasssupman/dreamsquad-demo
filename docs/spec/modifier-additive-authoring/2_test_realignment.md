...
- [x] (수동) Play smoke 확인 (2026-07-03, GameLog `session-...161038`): Guardian 2쌍 인접 배치(on-place boost affected_count=2 + synergy). Guardian Damage magnitude = **[19.5, 21.0]** — 21.0 = 15×(1+0.3 boost+0.1 synergy)=15×1.4 **합산**. 곱연산이면 나왔을 15×1.3×1.1=21.45 / 15×1.3×1.3=25.35 는 로그에 없음. 정책 B 실게임 확증.
