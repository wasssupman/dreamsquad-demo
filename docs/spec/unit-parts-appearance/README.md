...
**작성일**: 2026-07-07
**상태**: 계획 수립 (사용자 승인 대기)
**상위 맥락**: `docs/spec/spine-runtime-4-2-upgrade/` 후속. Layer Lab "2D Art Maker — AMCasual Character"(Spine 4.2.43, 파츠 스킨 480개/15 카테고리) 채택 완료, 전 Defender 가 `full_skins` 단일 스킨으로 렌더 중.
