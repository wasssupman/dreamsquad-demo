...
구현: 2026-08-01 · 커밋 `2805f70f`(리뷰 반영 `56c5c65d`·`a7a2a228`).
**사용자 Play 확인 2026-08-01 통과** — 두 번째 판 리빌 홀드 · 탭 진행 · 말풍선 위치
(`revealHintMessageTopOffset 880` 실화면 확정). 모바일 실기기 QA 는 계속 보류(사용자 결정).
