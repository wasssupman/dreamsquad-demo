...
**확인 2026-07-29 · 커밋 `ee5fd831`**(+ 튜닝 `698faf1a`·`b4a5fc32`) — 사용자 Play 확인. 스폰·외형 정상.
외형은 실플레이 피드백으로 확정: `Attack2`(0.70s) · `Run_Gear` · 오른손 스파이크 곤봉(`gear_right_c_39`) ·
왼손 파리채(`gear_left_c_36`) · 스케일 2.6. 나이트메어와 육안 구분 확인.
