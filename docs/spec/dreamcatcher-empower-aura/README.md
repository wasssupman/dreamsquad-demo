...
- **오라 아트** — **완료·정식화됨**: 5요소(오라 쉘·에너지 창끝·백라이트·충격파 링·크래클 스파크) 파랑/주황
  이중톤 + **전용 텍스처 2종**(Glow 라디얼 / Streak 화염혀) + 2 머티리얼. `EmpowerAura.prefab`(정식, _SKELETON
  제거), registry scale 0.7. 추가 아트 이터레이션(전용 셰이더 글로우·색 변주)은 선택적 후속.
