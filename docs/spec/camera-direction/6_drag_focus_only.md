...
> ⚠ **이 유닛이 도입한 `enableNonDragEffects` 토글은 unit 16 에서 은퇴했다** (2026-08-21).
> 이름이 «무엇을 끄는가» 가 아니라 «무엇이 살아남았는가» 기준이라 이후 채널 다섯이 전부
> 예외로 빠져나갔다. 지금은 채널마다 자기 데이터가 스위치다 —
> `16_shake_channel_independence.md` 참조. 아래는 당시 기록이다.
