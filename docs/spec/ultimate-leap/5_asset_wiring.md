...
- [ ] 2초 후 예고 타일 정중앙에 강하 착지, 슬램 피해가 들어간다
      ⚠ ~~예고된 타일과 **정확히 같은 범위**~~ — 2026-09-07 폐기(`distance-based-range` unit 24).
      예고는 몸을 모르고 피해는 대상 몸을 더하므로 **예고 ⊊ 피해**가 설계다. 이 항목으로
      「같은 범위」를 확인하지 말 것 — 확인할 것은 「예고 중심과 착지 지점이 같은가」다.
