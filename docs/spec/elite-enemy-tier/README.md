...
> 상태: **구현 중 (2026-08-12)** — 슬라임 경로 unit 0·5·6 구현·자동검증 통과, 사용자 Play 확인 대기.
> 드래곤 경로(unit 1·3·4·7) 미착수.
> 검증은 **적 1종 단위로 묶는다**(사용자 결정 2026-08-12): 슬라임 = 0·5·6 → 확인, 드래곤 = 1·3·4·7 → 확인.
> 라이브 덱 풀 등록은 **웨이브 baseline 이 바뀌므로 별도 커밋**으로 분리한다(unit 6 참조).
