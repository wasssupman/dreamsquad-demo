...
>
> **밸런스 확정** — `66004836`(슬라임 피해·체력 ×2, 드래곤 기본 20·브레스 50, 화염 10/틱).
> 라이브 플레이 확인 2026-08-13.
>
> **브레스는 즉발로 유지한다**(사용자 결정 2026-08-13, 플레이 확인 후). 「지속 콘」 전환을
> 검토했고 **하지 않기로 했다** — 비용 조사 결과는 중앙 백로그의 해당 항목에 남겼다
> (기존 장판 재사용은 진영 게이트·콘 도형 두 곳이 막혀 M 이상, 채널링은 선례 0, DoT 전환은
> 싸지만 「지속 콘」이 아니고 기존 화염 스택 화상과 겹친다).
