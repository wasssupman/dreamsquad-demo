...
**확인 2026-08-13** — 사용자 Play 확인 통과(슬라임 경로에 포함). 커밋 `1588a997`.
리뷰 반영 `ceb36396`(주석 정정: `nightmareMechanics` 필드 주석이 아직 «비어있지 않으면 곧
보스» 라고 말하고 있었다 — unit 0 이 정정을 지시한 항목인데 놓쳤던 것).
