...
- ~~**[높음] `UltimateLeap` 착지 예고가 «사각» 인데 피해는 «원»**~~ → **해소 2026-09-07**
  ...
  **안 맞는데 칠해지는** 자리도 있다(캐논 6 · 버스터즈 2). `TileAoeTests` 가 ①의 표본 2건을 박았다.
  ⚠⚠ **①은 unit 24 이전(사각 25칸)의 6/9/6/3 보다 «나쁘다»** — 이 unit 이 고치겠다고 선언한 바로
  그 축에서 후퇴했다. 원인은 헤드라인 정당화가 틀렸던 것: 「모서리는 안 맞는데 칠해졌다」는
  **대상을 점으로 놓고 잰 결과**이고, 실제로는 모서리 칸에 선 유닛이 전부 맞는다 —
  지운 4칸은 거짓 예고가 아니라 **진짜 경고**였다. 표기 규칙(몸 무관)의 재검토가 열려 있다.
