...
|---|---|---|---|---|---|---|
| `PT-DEC-PRODUCT-001` | common | Approved Demo 경험 중 production-v1에 포함·제외할 surface는 무엇인가? | `game-spec-approver` | open | true | Final reconciliation에서 두 coverage map과 함께 확정 |
