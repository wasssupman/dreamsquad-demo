...
|---|---|---|---|---|---|---|---|---|---|---|
| `MIG-AREA-001` | Match lifecycle와 terminal | `candidate` | [core-combat-lifecycle](cards/core-combat-lifecycle.md) | `partial` | `review_requested` | `blocked` | `MIG-AREA-004`, `MIG-AREA-005`, `MIG-AREA-012` | `MIG-DEC-CORE-006`, `MIG-DEC-CORE-007`, `MIG-DEC-CORE-008`, `MIG-DEC-CORE-012` | `2d35df0680ce97d29b78101120cb9fae63c5a8ad` | Core terminal 질문을 owner가 검토하거나 관련 gameplay spec이 완료될 때 |
